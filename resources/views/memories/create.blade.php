...
<form action="{{ route('memories.store') }}" method="POST">
  ...
  <div class=".paper container-sm">
    ...
    <input class="paper-input" type="text" id="title" name="title">
  </div>
  @error('title')
  ...
  <div class="form-group">
    ...
    <textarea class="large-input" id="text" name="text" style="width: 20rem;"></textarea>
  </div>
  @error('text')
  <div class="alert alert-danger">{{ $message }}</div>
  @enderror
  ...
  <div class="form-group">
    ...
    <input class="paper-input" type="color" id="color" name="color" value="{{ "#000000" }}">
  ...
  <div class="form-group">
    ...
    <input class="paper-input" type="text" id="image_url" name="image_url">
  </div>
  @error('image_url')
  <div class="alert alert-danger">{{ $message }}</div>
  @enderror

  <button class="paper-btn paper-btn-primary" type="submit">Create Memory</button>
